...
<div class="main-sidebar sidebar-style-2">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
      ...
      <li <?php echo ($page == "Electrocardiongram") ? "class=active" : ""; ?>><a class="nav-link" href="ecg_value.php"><i class="fas fa-file-medical-alt"></i> <span>Electrocardiogram</span></a></li>
